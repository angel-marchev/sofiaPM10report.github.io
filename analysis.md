...
![](/media/analysis1.png){:height="10px"}

![](/media/analysis2.png){:height="15px"}

![](/media/analysis3.png){:height="20px"}

![](/media/analysis4.png){:height="25px"}

![](/media/analysis5.png){:height="30px"}
...
Results are benchmarked against two naïve predictive models: 
![](/media/analysis6.png)
